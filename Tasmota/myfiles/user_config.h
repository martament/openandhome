...
#define CFG_HOLDER             0x20180409       // [Reset 1] Change this value to load following default configuration parameters
#define SAVE_DATA              15                 // [SaveData] Save changed parameters to Flash (0 = disable, 1 - 3600 seconds)
...
#define STA_SSID1              "openandhome"      // [Ssid1] Wifi SSID
#define STA_PASS1              "m2sxZeUZ"  // [Password1] Wifi password
...
// -- Ota -----------------------------------------
#define OTA_URL                "http://192.168.178.27:80/arduino/" PROJECT "-openandhome.bin"  // [OtaUrl]
...
#define MQTT_TOPIC             "schaltsteckdosen"           // [Topic] (unique) MQTT device topic
...
#define TIME_STD_OFFSET +120 // +60 minutes
// -- Application ---------------------------------
