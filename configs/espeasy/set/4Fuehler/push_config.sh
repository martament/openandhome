...
curl -v -F Upload=@../../standalone/resources/temperature.png http://$1/upload
curl -v -F Upload=@../../standalone/resources/temperature1.png http://$1/upload
curl -v -F Upload=@../../standalone/resources/openandhome_32.png http://$1/upload
echo "Sende Config"
