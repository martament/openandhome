Versuchen Sie immer zuerst das Programm reset_openandhome.bat !!!!!
...
reset_openandhome.bat:

Mit dem Programm reset_openandhome.bat (reset_openandhome.sh für Linux) können Sie die Einstellungen des Sensors zurück setzen. 
