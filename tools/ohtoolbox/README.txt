...
Das Programm ist ein kompilierte Powershelldatei. Daher wird diese von manchen Virenscannern fälschlicherweise als Bedrohung definiert. Sollten Sie damit ein Problem haben, so finden Sie die zugehörige openandhome-debugger.ps1 ebenfalls zum Download. Diese ist funktionsgleich der Exe, allerdings müssen Sie diese aus einer Powershell heraus aufrufen.
